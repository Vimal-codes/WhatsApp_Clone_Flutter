          ...
          bottomNavigationBar: NavigationBarTheme(
            data: NavigationBarThemeData(
              ...
              labelTextStyle: MaterialStateProperty.all(
                TextStyle(color: Color(0xFF565C5C),
                fontSize: 14,
                  fontWeight: FontWeight.bold,
                ),
            ...
            child: NavigationBar(
              ...
              destinations: [
                ...
                const NavigationDestination(icon: Icon(Icons.update_sharp), label: "Updates"),
                const NavigationDestination(icon: Icon(Icons.group), label: "Communities"),
                const NavigationDestination(icon: Icon(Icons.call), label: "Calls"),
              ],
            ),
          ),
        )
